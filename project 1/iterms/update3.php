...
$statement = $pdo->prepare('SELECT * FROM product2 WHERE id = :id');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (empty($errors)){
                ...
                $imagePath  = $product['image'];
                 ...
                 $statement = $pdo->prepare("UPDATE product2 SET title = :title, image = :image, description = :description, price = :price WHERE id = :id");
...
<html lang="en">
  ...
  <body>
    ...
    <p>
        <a href="dress.php" class="btn btn-secondary">go back to product</a>
    </p>
