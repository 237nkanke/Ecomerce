...
<body>
<h1><b>books shop<b></h1>
<p>
    <a href="creat4.php" class="btn btn-success">creat new product</a>
</p>
...
<table class="table">
  ...
  <tbody>
            ...
            <td>
            <a href="update4.php?id=<?php echo $product['id']?> type="button" class="btn btn-sm btn-outline-primary">edit</a>
            <form style="display: inline-block" method="post" action="delete4.php">
