...
<body>
<h1><b>dresses shop<b></h1>
<p>
    <a href="creat3.php" class="btn btn-success">creat new product</a>
</p>
...
<table class="table">
  ...
  <tbody>
            ...
            <td>
            <a href="update3.php?id=<?php echo $product['id']?> type="button" class="btn btn-sm btn-outline-primary">edit</a>
