...
<body>
<h1><b>telephone shop<b></h1>
<p>
    <a href="creat2.php" class="btn btn-success">creat new product</a>
</p>
<form>
...
<table class="table">
  ...
  <tbody>
            ...
            <td>
            <a href="update2.php?id=<?php echo $product['id']?> type="button" class="btn btn-sm btn-outline-primary">edit</a>
            <form style="display: inline-block" method="post" action="delete2.php">
              <input type="hidden" name="id" value="<?php echo $product['id']?>">
              <button  type="submit" class="btn btn-sm btn-outline-danger">delete</button>
            </form>
            <a href="../info/sign_in.php?id=<?php echo $product['id']?>" type="button" class="btn btn-sm btn-success">COMMAND</a>
            </td>
        </tr>
        <?php } ?>
