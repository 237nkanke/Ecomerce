...
$statement = $pdo->prepare('SELECT * FROM product1 WHERE id = :id');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (empty($errors)){
                ...
                $statement = $pdo->prepare("UPDATE product1 SET title = :title, image = :image, description = :description, price = :price WHERE id = :id");
...
<html lang="en">
  ...
  <body>
    ...
    <p>
        <a href="books.php" class="btn btn-secondary">go back to product</a>
    </p>
